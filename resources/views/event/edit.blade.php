                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input required type="text" class="form-control" id="inputName" name="name"
                                       placeholder="Enter name" value="{{$event->name}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="users" class="duallistbox" name="user_id[]" multiple="multiple">
                                    @foreach($users as $key => $user)
                                        @foreach($user->roles as $role)
                                            @if($role->name == 'Bar')
                                            @foreach($event->users as $evt_usr)
                                                    @if($evt_usr->id == $user->id)
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                    ...
                                    <input @if($event->status == 1) checked @endif type="checkbox"
                                           class="custom-control-input" id="inputStatus" name="status" value="1">
