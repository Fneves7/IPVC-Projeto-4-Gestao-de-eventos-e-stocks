            ...
            <div class="col-12">
                <div class="card card-secondary">
                    <div class="card-header">
                        <h3 class="card-title">@lang('view.createorder')</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form class="form-horizontal" id="yoyo" role="form" method="POST"
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input required type="button" class="btn btn-danger delete"
                                               value="x">
                                    </td>
                                </tr>
                                </tbody>
                            ...
                            <input hidden type="text" class="form-control" name="status" value="0">
...
{{--                       name="save" value="@lang('view.placeorder')">--}}
{{--            </div>--}}
{{--            <br>--}}
{{--            <div class="row">--}}
{{--                <button type="button" id='hideshow'--}}
{{--                        class="btn btn-primary btn-lg btn-block"--}}
{{--                        data-toggle="modal" data-target="#myModal">--}}
{{--                    @lang('view.generaterecipt')--}}
{{--                </button>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
